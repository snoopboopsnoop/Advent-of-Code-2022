...
int main() {
    ...
    // add divider packets to packets vector
    ...
    // add input packets to packet vector
    ...
    // find dividers, calculate result
    ...
    cout << "Decoder key for the distress signal: " << result << endl;
